...
Skills 与 MCP 的部署细节见 [`skills-and-mcp.zh-CN.md`](skills-and-mcp.zh-CN.md)。用户安装的 DSH bundle 计划作为叠加在此 composition 之上的 Profile 层，见 [`plugins.zh-CN.md`](plugins.zh-CN.md)。
