...
[教程](../tutorials.zh-CN.md) · 上一篇：[使用 Skills 与 MCP 扩展项目](skills-and-mcp.zh-CN.md) · 下一篇：[编写插件](write-a-plugin.zh-CN.md)
...
要自己编写 bundle，请继续 [编写插件](write-a-plugin.zh-CN.md)。兼容性约定见 [用户插件](../plugins.zh-CN.md)。
