...
[教程](../tutorials.zh-CN.md) · 上一篇：[调整工作环境](environment.zh-CN.md) · 下一篇：[安装示例插件](install-plugin.zh-CN.md)
...
Skills 与 MCP 不是插件 bundle。要编写并安装命令、工具、提供方或 Auth bundle，请继续 [编写插件](write-a-plugin.zh-CN.md) 和 [用户插件](../plugins.zh-CN.md)。
